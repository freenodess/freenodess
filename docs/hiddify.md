...
| ----------------------- | -------------------------------- | ------------------------------------------------ | ------------------------------------------------------------ |
| **Hiddify For Android** | ![img](./assets/hiddify-app.svg) | ![img](./assets/hiddify-app-1779350349666-1.svg) | [GitHub 下载](https://github.com/hiddify/hiddify-app/releases) / [Google Play](https://play.google.com/store/apps/details?id=app.hiddify.com) |
...
![Hiddify For Android  下载地址及使用教程 科学上网客户端下载使用汇总 ](./assets/131623-2.png)*v2rayNG 主界面*
...
![Hiddify For Android 下载地址及使用教程 科学上网客户端下载使用汇总 ](./assets/111620-3-1779350349707-6.png)

点击软件主界面【➕**新的配置文件**】按钮即可出现添加配置文件选项，如下图所示，根据不同的节点添加不同的节点服务器配置文件。

![Hiddify For Android 下载地址及使用教程 科学上网客户端下载使用汇总 ](./assets/131623-3.png)*新的配置文件*

在弹出的窗口选择**【从剪贴板添加】**或**【手动输入】**，一般选择**【手动输入】**，如下图所示。输入 **配置文件名称** 及 **节点订阅地址**，然后点击右上角的**【保存】**，如下图所示。

![Hiddify For Android 下载地址及使用教程 科学上网客户端下载使用汇总 ](./assets/131623-4.png)*添加配置文件*

成功导入节点配置文件后如下图所示。

![Hiddify For Android 下载地址及使用教程 科学上网客户端下载使用汇总 ](./assets/131623-5.png)*成功导入配置文件*

### 开启代理

点击【点击链接】，首次使用，在弹出的 **网络连接请求** 点击【**确定**】即可开启代理。

![Hiddify For Android 下载地址及使用教程 科学上网客户端下载使用汇总 ](./assets/131623-6.png)*开启代理*

### 选择代理节点

在添加完订阅地址之后，如果需要**切换代理节点**，点击软件主界面下方的**【代理】**选项卡，在代理列表里选择一个合适的代理节点即可，如下图所示。

![Hiddify For Android 下载地址及使用教程 科学上网客户端下载使用汇总 ](./assets/131623-7.png)*选择代理节点*
...
![Hiddify For Windows 下载地址及使用教程 科学上网客户端下载使用汇总 ](./assets/131623-8.png)*添加WARP*

## 常见问题

<details><summary>Hiddify 支持哪些代理协议？</summary><p>支持V2Ray、Xray、Reality、TUIC、Wireguard、Hysteria、SSH等代理协议。</p></details>